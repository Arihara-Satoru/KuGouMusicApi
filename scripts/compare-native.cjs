...
async function main() {
  ...
  try {
    ...
    const cases = [
      ...
      { module: 'lyric', route: '/lyric?id=1&accesskey=test&decode=true', compareShape: true },
      ...
      { module: 'sidedt', route: '/sidedt?eventid=1&userid=0&verifycode=test', compareShape: true },
      ...
      { module: 'song_url', route: '/song/url?hash=ABC&album_id=0&album_audio_id=0', compareShape: true },
      { module: 'song_url_new', route: '/song/url/new?hash=ABC&album_audio_id=0', compareShape: true },
